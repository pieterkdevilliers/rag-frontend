        ...
        <form @submit.prevent="handleSignup">
            ...
            <div class="flex flex-col md:flex-row md:items-end md:gap-4">
                ...
                <div class="mb-4 md:mb-0 md:flex-1">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="email_address">Email Address</label>
                    <UInput
                ...
                <div class="mb-4 md:mb-0 md:flex-1">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1" for="account_organisation">Account Organisation</label>
                    <UInput
...
const handleSignup = async () => {
  try {
    ...
    const user = await fetch(`https://fastapi-rag-2705cfd4c41a.herokuapp.com/api/v1/users/${uniqueAccountId}`, {
      method: 'POST',
      headers: {
